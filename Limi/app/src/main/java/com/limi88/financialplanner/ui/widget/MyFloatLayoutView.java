 ...
 */
public class MyFloatLayoutView extends ViewGroup {
    ...
    public MyFloatLayoutView(Context context) {
        this(context, null);
        this.context = context;
        // TODO Auto-generated constructor stub
    }

    public MyFloatLayoutView(Context context, AttributeSet attrs) {
    ...
    public MyFloatLayoutView(Context context, AttributeSet attrs, int defStyle) {
