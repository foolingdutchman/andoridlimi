...
import com.limi88.financialplanner.util.SystemUtils;
...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        //判断app进程是否存活
        if(SystemUtils.isAppAlive(context, "com.limi88.financialplanner")){
            ...
            Intent detailIntent = new Intent(context, BaseWebViewActivity.class);
