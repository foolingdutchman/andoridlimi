...
public class SearchDao extends AbstractDao<Search, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property SearchTitle = new Property(1, String.class, "searchTitle", false, "SEARCH_TITLE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEARCH\" (" + //
                ...
                "\"SEARCH_TITLE\" TEXT);"); // 1: searchTitle
    }
    ...
    public Search readEntity(Cursor cursor, int offset) {
        Search entity = new Search( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // searchTitle
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Search entity, int offset) {
        ...
        entity.setSearchTitle(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
